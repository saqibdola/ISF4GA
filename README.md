...
### The framework can also be used to find the overall composition of nucleotide bases and amino acids, GC and AT/GC contents, and the codon base composition in the whole genomes as well as in different genes. 

#### This repositry contains the pyhton codes for the framework.
